...
$summary = [ordered]@{
    ...
    dry_run                     = [bool]$DryRun
    notes                       = "PROMPT 1603 launcher; PROMPT 1640 CCGS_BOT_MAX_ROUNDS; PROMPT 1671 port-detection; PROMPT 1672 bot-soak-trigger wired; PROMPT 1676 snapshot dir env-var fixed."
}
