...
**Re-applied by:** PROMPT 1871 (re-lands on top of origin/main @ 5c91918d, preserving PROMPT 1845/1858 reports)  
...
5. **An automated PASS requires the repairs in PROMPT 1844 AC-VPT-01 through AC-VPT-08.**  
   ...
   checkpoint). These are not landed on `main` as of `bb90d7c2`.
...
## 8. Disposition of origin/wt/1866-report-truth-reconcile

The branch `origin/wt/1866-report-truth-reconcile` (where this report was first
authored) could NOT be main-landed because it was built from `origin/main @ bb90d7c2`
and would have deleted the PROMPT 1845 and 1858 reports (which landed in commits
after that base). PROMPT 1871 re-applies the same correction content cleanly on top
of the current origin/main (`5c91918d`) without disturbing those reports.
...
1866: AUTOPLAY-1831-1840-REPORT-TRUTH-RECONCILE: DONE (re-landed by PROMPT 1871)
