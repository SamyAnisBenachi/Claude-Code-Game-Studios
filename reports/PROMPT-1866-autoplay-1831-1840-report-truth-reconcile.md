...
## 8. Disposition of origin/wt/1840-report-backfill

The branch `origin/wt/1840-report-backfill` contains:
- `reports/PROMPT-1831-autoplay-vsbot-fresh-post-1818-live-verify.md` — the original uncorrected PASS report
- `reports/PROMPT-1840-autoplay-vsbot-1831-report-backfill-reconcile.md` — the 1840 reconciliation doc

**Do not main-land this branch.** The corrected version of the 1831 report is
committed on `wt/1866-report-truth-reconcile`. If the 1840 reconciliation doc
is needed on main, it should be cherry-picked only after removing or annotating
its DONE/PASS verdict for run `090613`.
...
1866: AUTOPLAY-1831-1840-REPORT-TRUTH-RECONCILE: DONE
