...
> **NOTE (backfilled by PROMPT 1867):** This is an **observability gap audit** of the
> QA snapshot system. It documents what data fields the snapshot captures and what it
> does NOT capture. It is **not** proof of GUI correctness, autoplay PASS/FAIL, or
> bot behaviour. Evidence verdicts (PASS/FAIL/PARTIAL) must come from live run data,
> `analyze_evidence_run.py` (PROMPT 1833), and the viewport/click audit (PROMPT 1844).
