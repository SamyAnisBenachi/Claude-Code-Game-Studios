# PROMPT 1975 — Autoplay Mid-Run Viewport Shrink Guard Refresh After 1972

**Branch**: `worker/1975-autoplay-midrun-viewport-shrink-guard-refresh-after-1972`
**Base**: `origin/main @ 7b259e91` (PROMPT 1972 — autoplay vsbot signoff-pack reports refresh after 1959)
**Date**: 2026-05-28
...
PROMPT 1971 built a clean transplant of the viewport shrink guard onto
`origin/main@7fc1706e` (post-1959), but its worker branch
(`origin/worker/1971-autoplay-midrun-viewport-shrink-guard-refresh-after-1959 @ 7133a0f0`)
was NOT fast-forward against `origin/main@7b259e91` after PROMPT 1972 landed.
Wholesale merge or cherry-pick would delete the PROMPT 1972 signoff-pack reports.

This PROMPT performs a clean file-level transplant of only the owned scope onto
fresh `origin/main@7b259e91`, preserving all current-main work.
...
| File | Source | Action |
|------|--------|--------|
| `tools/autoplay/viewport_shrink_guard.py` | `origin/worker/1971-autoplay-midrun-viewport-shrink-guard-refresh-after-1959 @ 7133a0f0` | Transplanted (file-level `git show`) |
...
| `reports/PROMPT-1975-autoplay-midrun-viewport-shrink-guard-refresh-after-1972.md` | this file | New |
...
```
Branch is strict fast-forward over `origin/main@7b259e91`.
...
```
5 files, additions only; no deletions; all within owned scope.
(PROMPT-1975 report added after this validation, also owned scope.)
...
Confirmed unchanged on this branch vs `origin/main@7b259e91`:
...
1975: AUTOPLAY-MIDRUN-VIEWPORT-SHRINK-GUARD-REFRESH-AFTER-1972: READY_FOR_MAINLAND_ENQUEUE
