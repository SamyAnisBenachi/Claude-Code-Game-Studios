<!-- CORRECTION NOTICE — added by PROMPT 1866, re-applied by PROMPT 1871 (2026-05-28) -->
...
**Corrected Status:** CONDITIONAL — human-review required (PROMPT 1866, re-applied PROMPT 1871)  
**Branch at execution:** main @ `71484998`  
**Evidence dir:** `production/qa/evidence/autoplay-runs/20260528-090613-Z`

---

## ⚠️ Correction Summary (PROMPT 1866 / PROMPT 1871)
...
PROMPT 1871 note: This correction was first produced by PROMPT 1866 on branch
`origin/wt/1866-report-truth-reconcile`. That branch was not FF-mergeable to origin/main
(it would have deleted the PROMPT 1845/1858 reports). PROMPT 1871 re-applies the same
correction header on top of the current origin/main without touching those reports.
...
> ⚠️ **Correction (PROMPT 1866/1871):** The tick=138 "window resized: 1296x759 → 1296x1115"
...
> ⚠️ **Correction (PROMPT 1866/1871):** Checkpoints are time-based counters, not
...
> **Reinforced by PROMPT 1866/1871:** The AUTOPLAY-VS-BOT-QA-001 automated PASS gate
...
1831: AUTOPLAY-VSBOT-FRESH-POST-1818-LIVE-VERIFY: CONDITIONAL (corrected by PROMPT 1866, re-applied PROMPT 1871)
