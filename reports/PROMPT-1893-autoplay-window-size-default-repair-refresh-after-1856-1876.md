# PROMPT 1893 — Autoplay Window-Size Default Repair Refresh After PROMPT 1856/1876
...
- `reports/PROMPT-1879-autoplay-window-size-default-repair-refresh-after-1872.md` — backfilled
- `reports/PROMPT-1893-autoplay-window-size-default-repair-refresh-after-1856-1876.md` — this report

---

## Files NOT Touched

- `tools/dev-launcher/Start-AutoplayVsBot.ps1` — FORBIDDEN per scope
- `reports/PROMPT-1856-ui-1280x720-layout-smoke-slice-f.md` — preserved (main)
- `reports/PROMPT-1876-dev-launcher-autoplay-evidence-ux-refresh-after-1872.md` — preserved (main)
...
| `git diff --name-status origin/main..HEAD` | Only M/A on owned scope files — no deletions |
| PROMPT 1856 report present | PASS — untouched |
| PROMPT 1876 report present | PASS — untouched |
