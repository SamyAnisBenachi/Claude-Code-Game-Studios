...
| # | System | File | Status | Notes |
|---|---|---|---|---|
| 17 | Keyword System | `gdd/keyword-system.md` | Needs Revision | /design-review R4 full 2026-05-01: NEEDS REVISION (19 blockers) → R5 inline pass complete. Key R5 fixes: Formula 2 rewritten as piecewise (enemy/friendly branches explicit); Formula 1 lane precondition added; outnumbered_cache update contract added; Replication Contract snapshot timing specified; OQ-KS7 resolved (SilenceApplied + stripped_keywords); OQ-KS8 resolved (CounterattackFired + target_id); STUN+DEATH exception added (STUN does NOT suppress DEATH trigger); DEATH trigger kill-gold rule added; TELEPORT co-occupation edge case added; COUNTERATTACK chain 2nd-link HP snapshot added; Player Fantasy SILENCE test narrowed to achievable bar; KW-072 duplicate deleted; KW-051/052 demoted to ADVISORY (OQ-KS4 dependency); KW-056 fixture defined; 7 new BLOCKING ACs (KW-075–KW-081). R5 re-review recommended (fresh session). |
