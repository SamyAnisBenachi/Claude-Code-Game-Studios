...
| BL-8 | GIVEN Player A already has a Minion in lane 3, WHEN they submit another Minion to lane 3, THEN the second placement is rejected and gold is not deducted. | BLOCKING |
...
| BL-29 | GIVEN Player A already has a Field active in lane 2, WHEN Player A submits a second Field to lane 2, THEN the placement is rejected and gold is not deducted. | BLOCKING |
