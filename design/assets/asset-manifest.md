...
| ASSET-024 | env_lane_number_label_01–05 (×5) | Environment / UI | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-025 | env_cell_node_idle_32x32 | Environment | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-026 | env_cell_node_spawn_active_32x32 | Environment | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
...
| ASSET-029 | env_objective_unknown_64x96 | Environment | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-030 | env_objective_real_reveal_64x96 | Environment | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
...
| ASSET-033 | ui_unit_base_player_a_48x16 | UI | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-034 | ui_unit_base_player_b_48x16 | UI | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-035 | ui_trap_tile_facedown_32x32 | Environment (world-space) | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
...
| ASSET-039 | ui_unit_placeholder_48x64 | UI / Error State | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
| ASSET-040 | vfx_objective_real_flash (×3 frames) | VFX | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
...
| ASSET-044 | hp_bar_white_pixel_1x2 | Reserved Atlas Frame | BLOCKING | Needed | design/assets/specs/board-rendering-assets.md |
