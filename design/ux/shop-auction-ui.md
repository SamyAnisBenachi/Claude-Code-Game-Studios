...
| OQ-SAU-UX-3 | HUD/art direction says DRAFT_AUCTION replaces the board, while the Shop/Auction GDD UI Requirements say the board must not be occluded. This spec treats auction as the explicit exception; architecture/design review should confirm this wording. | UX Designer + UI Programmer | Medium |
