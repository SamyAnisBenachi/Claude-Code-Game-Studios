...
>
> - **Source-of-truth at this update**: `origin/main@1617352` (PROMPT 790's smoke evidence commit `qa(smoke): Sprint 11 smoke check`; PROMPT 791 pushes one paperwork commit on top with the Team-QA sign-off evidence).
