...
808 integration (`55b25be`). Before `/dev-story` begins on any Must
Have / Should Have / Nice to Have row, the following story files must
exist and pass `/story-readiness` against Sprint 13 activation HEAD:

| Planned ID | Required story file | Status at draft time |
|------------|---------------------|----------------------|
| S13-PROTO-INVARIANT-001 | `production/epics/lightyear-protocol-verification/story-007-protocol-completeness-invariant.md` | EXISTS on `main` at `55b25be` (PROMPT 804 / PROMPT 808); `/story-readiness` pending |
| S13-PROTO-ORPHAN-DRAIN-001 | `production/epics/lightyear-protocol-verification/story-008-protocol-orphan-drain.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S13-FIXTURE-FACTORY-001 | `production/epics/playable-client/story-016-fixture-factory.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S13-TWO-CLIENT-RUNTIME-HARNESS-001 | `production/epics/playable-client/story-017-two-client-runtime-harness.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S13-OBS-TRACING-TARGETS-001 | `production/epics/playable-client/story-018-obs-tracing-targets.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S13-OBS-WALLCLOCK-TIMESTAMPS-001 | `production/epics/playable-client/story-019-obs-wallclock-timestamps.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending. **Note**: This is a Sprint 13 candidate story-019 file in the `playable-client/` epic; it is **distinct from** the Sprint 12 hand-ui story-019 (`production/epics/hand-ui/story-019-drag-runtime-retest-tighter-capture.md`) which is already `Done` with `closed-with-conditions / cannot-reproduce` disposition. |
| S13-LATE-MSG-DEDUPE-001 | `production/epics/playable-client/story-020-late-msg-dedupe.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S13-CONN-LOST-UX-001 | `production/epics/playable-client/story-021-conn-lost-ux.md` | EXISTS on `main` at `55b25be`; `/story-readiness` pending |
| S11-HUD-TIMER-EYEBALL-VISUAL-001 | `production/epics/hud/story-XXX-hud-timer-eyeball-visual-check.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-HU-PHASE-IDEMPOTENCY-001 | `production/epics/playable-client/story-XXX-client-phase-changed-idempotency.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-SERVER-POOL-INIT-LOG-GUARD-001 | `production/epics/server/story-XXX-init-pool-log-guard.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-LOBBY-UX-CONFIRM-STATE-001 | `production/epics/playable-client/story-XXX-lobby-confirm-state.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-TD-CARGO-DISK-USAGE-001 | `production/epics/devops/story-XXX-cargo-workspace-disk-usage.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-TD-CARGO-PDB-LIMIT-001 | `production/epics/devops/story-XXX-cargo-pdb-limit.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-OPS-ORCHESTRATOR-LOCK-001 | `production/epics/devops/story-XXX-orchestrator-lock.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-OPS-GH-CLI-001 | `production/epics/devops/story-XXX-gh-cli-setup.md` (NEW) | Does not yet exist; story file authoring pending |
| S11-SERVER-R2-PLACEMENT-CRASH-AUDIT-001 | `production/epics/server/story-XXX-r2-placement-crash-audit.md` (NEW) | Does not yet exist; story file authoring pending |
| S13-OPS-WIN-APPCOMPAT-NOTE-001 | `production/epics/devops/story-XXX-win-appcompat-note.md` (NEW) | Does not yet exist; story file authoring pending |
| S13-UI-AUDIT-ROADMAP-PREP-001 | `production/epics/ui-clean-pass/story-XXX-prompt-802-audit-roadmap-prep.md` (NEW) | Does not yet exist; story file authoring pending |

Until story files exist and pass `/story-readiness`, the corresponding
sprint-status rows remain `blocked` at activation.
