...
| QA-COND-0002 | Ignored AUC-006 auction test | Test Debt | S3 Medium | P2 Sprint 6 validation | Open | Needs Decision | Sprint 5 non-blocking condition; decision required before closure |
...
| QA-COND-0004 | Browser/WASM board performance capture | Performance Gap | S2 High | P1 Sprint 6 gate blocker | Open | Needs Evidence | Production-to-Polish hard blocker |
