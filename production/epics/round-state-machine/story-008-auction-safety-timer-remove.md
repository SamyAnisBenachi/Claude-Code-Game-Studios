# Story 008: S18-RSM-AUCTION-SAFETY-TIMER-REMOVE-001 — Remove Dead `RoundState.auction_safety_timer`
...
6. Evidence file path: `tests/evidence/rsm-story-008-auction-safety-timer-
   remove.md`.
