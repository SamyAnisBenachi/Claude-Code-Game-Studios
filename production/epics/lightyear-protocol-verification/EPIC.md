...
| 009 | [S18-PROTOCOL-RECEIVER-DRAIN-SMOKE-TESTS-001 -- Cover Real MessageReceiver Drain Path (F-08 Partial)](story-009-protocol-receiver-drain-smoke-tests.md) | Integration (tests-only) | Draft -- Sprint 18 candidate / retro paperwork (landed at commit `2c76959`, PROMPT 1246); NOT activated | ADR-002, ADR-008 |

> Story 009 is a PROMPT 1296 retro paperwork stub for Sprint 18 candidate landed work covering a partial F-08 close (real-wire receiver-drain smoke). The broader snapshot-bypass migration (`S18-PROTOCOL-SNAPSHOT-REAL-WIRE-TESTS-001`, PROMPT 1287 Lane W10) remains open.
