...
| 009 | [PlayerSnapshot.submitted Drop-vs-Wire Disposition](story-009-playersnapshot-submitted-disposition.md) | Decision-first (Path A drop / Path B wire / Path C defer) | Draft — Sprint 18 candidate (S18-PROTO-PLAYERSNAPSHOT-SUBMITTED-DISPOSITION-001 per PROMPT 1298 / authored by PROMPT 1305), NOT activated. Path B is HARD-BLOCKED on `S18-RSM-SUBMISSIONS-RECEIVED-CLEAR-001` (F-07 fix); Path A has no dependency | ADR-002, ADR-003, ADR-008 |
