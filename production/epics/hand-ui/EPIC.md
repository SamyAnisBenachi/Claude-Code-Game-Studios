...
| 024 | [S19-UI-HAND-FAN-KROSMAGA-LAYOUT-001 -- Krosmaga-Style Hand Fan Layout](story-024-krosmaga-hand-fan-layout.md) | UI + Integration | Draft -- future Sprint 19 candidate (`S19-UI-HAND-FAN-KROSMAGA-LAYOUT-001`; PROMPT 1280 Krosmaga-style implementation wave; packaged by PROMPT 1286, integrated by PROMPT 1372), NOT activated | ADR-021, ADR-002, ADR-012, ADR-009 |
