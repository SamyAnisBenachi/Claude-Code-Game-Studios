...
- [ ] **AC1 -- Test bin authored**: GIVEN the story commit, WHEN the
  ...
  height determinism). Verification: code review.

- [ ] **AC2 -- Helper module authored**: GIVEN the story commit, WHEN
...
- [ ] **AC3 -- Baseline fixture authored**: GIVEN the story commit,
...
- [ ] **AC4 -- All six viewport sizes covered**: GIVEN the test bin,
...
- [ ] **AC5 -- No-overlap invariant detects synthesized overlap**:
...
- [ ] **AC6 -- No-clipping invariant detects synthesized clipping**:
...
- [ ] **AC7 -- Baseline mismatch fails clearly**: GIVEN the test bin,
  ...
  negative test that synthesizes a drift.

- [ ] **AC8 -- CI wiring**: GIVEN the story commit, WHEN the
...
- [ ] **AC9 -- Failing assertions surface follow-on rows, not
...
- [ ] **AC10 -- Friend-game scope preserved**: GIVEN the story commit,
