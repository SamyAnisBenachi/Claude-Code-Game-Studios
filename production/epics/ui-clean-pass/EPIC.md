...
| 023 | [QA Snapshot Layout-Debug Field Enrichment (Q-01..Q-10)](story-023-obs-snapshot-layout-fields.md) | Tech Debt -- observability extension (Integration) | Done -- Sprint 18 Should Have (closed PROMPT 1714 on `origin/main@3a4f7721`; impl PROMPT 1186 `d75db1af`; AC1..AC18 PASS; AC13 3 null-field limitations in evidence.md) | S18-OBS-SNAPSHOT-LAYOUT-FIELDS-001 |
| 024 | [Settings Panel Flex Re-Layout + UI-Scale Invariant](story-024-ui-settings-panel-flex-relayout.md) | Tech Debt -- per-surface re-layout (Integration) | Done -- Sprint 18 Should Have (closed PROMPT 1331 on `origin/main@4940a7b`; impl PROMPT 1187 `8eeb94e`; AC1..AC13 PASS, AC7 PASS-STRUCTURAL + ADVISORY-EVIDENCE-DEFERRED; PROMPT 1324 readiness verdict `READY_FOR_STORY_DONE`; test landed under `tests/integration/accessibility_settings/` per existing sibling pattern, paperwork-only mismatch with spec path `tests/integration/settings/` recorded in Completion Notes) | S18-UI-SETTINGS-PANEL-FLEX-RELAYOUT-001 |
...
| 027 | [Global UI Layout Contract Doc + Button-vs-Chip Lint](story-027-ui-layout-contract-doc-and-lint.md) | UX -- contract authoring + lint enforcement (Documentation + Integration) | Done -- Sprint 18 Must Have (closed PROMPT 1337 on `origin/main@72b89ca` after PROMPT 1188 worker `c2eaab0` + PROMPT 1208 integration `ae8f7d1` + PROMPT 1334 AC9 cross-link backfill main-landed by PROMPT 1335 at `72b89ca`; AC1..AC5 + AC7..AC16 PASS; AC6 ADVISORY L4 chip-side static lint deferred per contract §10 false-positive-surface rationale; PROMPT 1327 first `/story-done` returned NEEDS_WORK on AC9, discharged by 1334/1335, relaunched by 1337) | S18-UI-LAYOUT-CONTRACT-DOC-AND-LINT-001 |
