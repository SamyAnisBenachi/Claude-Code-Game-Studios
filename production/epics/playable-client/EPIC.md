...
| 027 | [Lobby Confirm CTA Reachability & Room-Browser Layout](story-027-lobby-confirm-cta-visible.md) | UI + Integration -- viewport-invariant Confirm-CTA reachability at 1280x720 / 1366x768 / 1920x1080, bounded room-list overflow, row-click vs informational row distinction, chip-only-confirmation guard, two-client reach-to-`DraftInitial` evidence; QA-COND-0005 accept-risk preserved | Draft - Sprint 18 Wave-A candidate (`S18-LOBBY-CONFIRM-CTA-VISIBLE-001` per PROMPT 1287 §5; PROMPT 1201 HUNT-1201-01 / -02 / -20 + PROMPT 1180 L-01 / L-03), NOT activated | S18-LOBBY-CONFIRM-CTA-VISIBLE-001 |
...
> Story 027 is a **Sprint 18 Wave-A candidate** lobby Confirm-CTA reachability + room-browser layout row authored by PROMPT 1294 per PROMPT 1287 §5. Source-of-truth at authoring: `origin/main@1345c6b` (PROMPT 1285 Sprint 18 plan draft). Friend-game-scope only; preserves the `QA-COND-0005` accept-risk verbatim (no Standard-tier ≥44 Px claim; AC9 BLOCKING gate ensures Story 026 dimension-stability regression PASSES). Story 027 is NOT activated by PROMPT 1294; activation happens via a separate Sprint 18 activation prompt after the activation blockers in `production/sprints/sprint-18.md` §0 clear. Sibling Wave-A stories `S18-HAND-FAN-PASSIVE-CLICK-AFFORDANCE-001` and `S18-HAND-FAN-Z-LAYER-AUCTION-001` were authored under `production/epics/hand-ui/` (stories 025 / 026 in that epic) in the same PROMPT 1294 run.
